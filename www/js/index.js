...
angular.module('newsLoader',[]).service('nana', ['$http', function ($http) {
  this.get_news = function(){
    return $http({method: "POST"}).jsonp("https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20html%20where%20url%20%3D%20'http%3A%2F%2Fwww.mizukinana.jp%2Fnews%2Findex.html'%20and%20xpath%20%3D%20'%2F%2Fh3'%3B&format=json&diagnostics=true").then(
      function (response) {
